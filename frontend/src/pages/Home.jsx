              ...
              {topProducts.map((product, index) => (
                ...
                >
                  <div
                    ...
                    className="group block bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200/50 hover:border-primary/30 hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer transform hover:-translate-y-2"
                  >
                    ...
                    <div className="p-5 bg-white">
                      ...
                      {product.teluguName && (
                        <p className="text-gray-500 text-xs mb-2 italic">{product.teluguName}</p>
                      )}
                      <p className="text-gray-400 text-xs mb-4 font-medium uppercase tracking-wide">{product.category}</p>
                      <button
                        onClick={() => handleProductClick(product)}
                        className="w-full py-3 rounded-xl font-bold text-sm bg-gradient-to-r from-[#25D366] to-[#20BA5A] text-white hover:from-[#20BA5A] hover:to-[#1DA851] transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 transform hover:scale-105"
                      >
